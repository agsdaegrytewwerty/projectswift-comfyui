...
class BatchedBrownianTree:
    ...
    def __init__(self, x, t0, t1, seed=None, **kwargs):
        try:
            ...
            raise RuntimeError("This sampler requires the optional torchsde package") from error
...
def linear_multistep_coeff(order, t, i, j):
    try:
        ...
        raise RuntimeError("The LMS sampler requires the optional scipy package") from error
    if order - 1 > i:
