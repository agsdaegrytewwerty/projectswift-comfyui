...
def reshape_latent_to(target_shape, latent, repeat_batch=True):
    ...
    return comfy.utils.repeat_to_batch_size(latent, target_shape[0]) if repeat_batch else latent
...
class ColorTransfer(io.ComfyNode):
    ...
    def _to_lab(images, i, device):
        try:
            ...
            raise RuntimeError("Color transfer requires the optional kornia package") from error
