...
# The ProjectSwift worker is pinned to one Illustrious/SDXL checkpoint. Keeping
# unrelated detectors active makes accidental model-family imports possible
# even though their runtime data is intentionally omitted from the bundle.
models = [SDXL]
