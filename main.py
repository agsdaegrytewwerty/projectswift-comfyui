...
from app.projectswift_lean import asset_seeder, register_output_files
import itertools
...
def setup_database():
    """The lean worker intentionally has no asset database."""
    if args.enable_assets:
        raise RuntimeError("--enable-assets is unavailable in the ProjectSwift lean runtime")
